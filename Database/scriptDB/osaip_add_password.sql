...
-- -----------------------------------------------------
-- Table `oasip`.`lecturer_event`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `oasip`.`lecturer_event` (
  `eventbooking_id` INT NOT NULL,
  `user_lecturer` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`eventbooking_id`, `user_lecturer`),
  INDEX `fk_eventbooking_has_user_user1_idx` (`user_lecturer` ASC) VISIBLE,
  INDEX `fk_eventbooking_has_user_eventbooking1_idx` (`eventbooking_id` ASC) VISIBLE,
  CONSTRAINT `fk_eventbooking_has_user_eventbooking1`
    FOREIGN KEY (`eventbooking_id`)
    REFERENCES `oasip`.`eventbooking` (`booking_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_eventbooking_has_user_user1`
...
-- -----------------------------------------------------
-- Table `oasip`.`student_event_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `oasip`.`student_event_category` (
  `eventcategory_id` INT NOT NULL,
  `user_student` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`eventcategory_id`, `user_student`),
  INDEX `fk_eventcategory_has_user_user1_idx` (`user_student` ASC) VISIBLE,
