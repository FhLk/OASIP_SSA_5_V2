...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`eventbooking` (
  ...
  CONSTRAINT `fk_eventbooking_eventcategory`
    ...
    REFERENCES `mydb`.`eventcategory` (`category_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mydb`.`eventcategory_owner`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`eventcategory_owner` (
